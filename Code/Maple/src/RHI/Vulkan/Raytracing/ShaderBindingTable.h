...
namespace maple
{
	...
	public:
		...
		inline auto& getStages() const { return stages; }
		inline auto& getGroups() const { return groups; }

		inline auto getHitGroupOffset() const { return rayGenSize + missGroupSize; }
		inline auto getMissGroupOffset() const { return rayGenSize; }
	private:
