...
namespace maple
{
	...
	public:
		...
		inline auto getSize() const { return geometries.size(); }
		inline auto& getGeometry() const { return geometries; }
		inline auto& getBuildOffsetInfo() const { return buildOffsetInfos; }
