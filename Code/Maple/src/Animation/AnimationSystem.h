...
namespace maple
{
	namespace animation
	{
		...
		inline auto isPaused(const component::Animator &animator)
		{
			return animator.paused;
		}
		inline auto isStarted(const component::Animator &animator)
		{
			return animator.started;
		}
		inline auto isPlaying(const component::Animator &animator)
		{
			return !animator.paused && !animator.stopped;
		}
		inline auto isStopped(const component::Animator &animator)
		{
			return animator.stopped;
		}
		inline auto getTime(const component::Animator &animator)
		{
