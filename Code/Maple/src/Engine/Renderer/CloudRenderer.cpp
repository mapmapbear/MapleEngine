...
namespace maple
{
	...
	{
		using Entity = ecs::Registry ::Modify<component::CloudRenderData>::Fetch<component::CameraView>::Fetch<component::RendererData>::Modify<component::WeatherPass>::Modify<Timer>::Fetch<component::WindowSize>::Modify<capture_graph::component::RenderGraph>::To<ecs::Entity>;

		using Group = ecs::Registry ::Fetch<component::VolumetricCloud>::Fetch<component::Light>::Fetch<component::Transform>::To<ecs::Group>;
	...
	{
		using Entity = ecs::Registry ::Modify<component::CloudRenderData>::Fetch<component::CameraView>::Fetch<component::RendererData>::Fetch<component::WeatherPass>::Modify<capture_graph::component::RenderGraph>::To<ecs::Entity>;
