...
namespace maple
{
	...
	namespace atmosphere_pass
	{
		...
		{
			using Entity = ecs::Registry ::Modify<component::AtmosphereData>::Fetch<component::RendererData>::Fetch<component::CameraView>::Modify<capture_graph::component::RenderGraph>::To<ecs::Entity>;

			using Group = ecs::Registry ::Fetch<component::Atmosphere>::Fetch<component::Light>::Fetch<component::Transform>::To<ecs::Group>;

			inline auto system(Entity entity, Group query, ecs::World world)
			{
		...
		namespace on_render
		{
			using Entity = ecs::Registry ::Modify<component::AtmosphereData>::Fetch<component::RendererData>::To<ecs::Entity>;
