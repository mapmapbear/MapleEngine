...
namespace maple
{
	...
	namespace on_begin
	{
		using Entity = ecs::Registry ::Fetch<component::RendererData>::Modify<component::GridData>::Modify<component::CameraView>::To<ecs::Entity>;
	...
	namespace on_render
	{
		using Entity = ecs::Registry ::Fetch<component::GridData>::Fetch<component::RendererData>::Fetch<component::GridRender>::To<ecs::Entity>;
		inline auto system(Entity entity, ecs::World world)
		{
